...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('dashboard.index') }}">
            ...
            <div class="sidebar-brand-text mx-3">VK-scrappy</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseSettings" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Список настроек:</h6>
                    <a class="collapse-item" href="buttons.html">Аккаунт</a>
                    <a class="collapse-item" href="cards.html">Доступы ВК</a>
                </div>
            </div>
        </li>
        ...
        <!-- Nav Item - Панель управления -->
        <li class="nav-item">
            <a class="nav-link" href="{{ $urlForCode }}">
        ...
        <div id="content">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <!-- Nav Item - Messages -->
                    <li class="nav-item dropdown no-arrow mx-1">
                        <form action="{{  route('logout') }}" method="POST" class="nav-link form-inline">
                            @csrf
                            <input type="submit" class="text-danger" value="Выход">
                        </form>
                    </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>vk-scrappy.ru - Copyright © 2022</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
